...
export const EXPERIENCE_ADDED = "The required experience was saved."
export const EXPERIENCE_NOT_ADDED = "The required experience was not added. Please try again!"
export const EXPERIENCE_ALREADY_EXISTS = "The required experience is already added!";
export const EXPERIENCE_DELETED = "The experience was deleted succesfully.";


export const LANGUAGE_ADDED = "The required language was saved."
export const LANGUAGE_NOT_ADDED = "The required language was not added. Please try again!"
export const LANGUAGE_ALREADY_EXISTS = "The language experience is already added!";
export const LANGUAGE_DELETED = "The language was deleted succesfully.";
